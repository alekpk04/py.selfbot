    ...
    try:
        ...
        if op.type == 5:
            ...
            if settings["autoAdd"] == True:
                cl.sendMessage(op.param1, "Ehem thanks kak udh add...rename jangan lupa nah:D".format(str(cl.getContact(op.param1).displayName)))
        if op.type == 13:
        ...
        if op.type == 25:
            ...
            if msg.contentType == 0:
                ...
                if text.lower() == 'Tagall':
                    ...
                    cl.sendContact(to, "ubf4012671c609c2332747084066xxxxx")
                elif text.lower() == 'Clearchat':
                    cl.removeAllMessages(op.param2)
                    cl.sendMessage(to, "chat sudah bersih kak")
                    ...
                    cl.sendMessage(to, "restart done...")
                    restartBot()
                    ...
                    try:
                        arr = []
                        owner = "ubfxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
                   ...
                   if settings["notifikasi"] == False:
                       ...
                       if settings["lang"] == "JP":
                           cl.sendMessage(msg.to,"notif mode off")
                            ...
                            settings["wait"] = True
                            cl.sendMessage(to, "kirim photonya")
                elif text.lower() == 'ganti pp gc':
                            if msg.toType == 2:
                                if to not in settings[" "]:
                                    settings[" "].append(to)
                                cl.sendMessage(to, "kirim  photonya bosquh")
                    ...
                    settings["Sider"] = True
                    cl.sendMessage(msg.to,"CCTV ON")

                elif text.lower() == 'Read off':
                    if msg.to in cctv['point']:
                       cctv['cyduk'][msg.to]=False
                       settings["Sider"] = False
                       cl.sendMessage(msg.to,"CCTV OFF")
                    else:
                        cl.sendMessage(msg.to,"CCTV OFF")
